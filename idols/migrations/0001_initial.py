    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Girl_group', models.CharField(blank=True, choices=[('GirlGroup', 'GirlGroup'), ('BoyGroup', 'BoyGroup')], max_length=30, null=True)),
                ('Boy_group', models.CharField(blank=True, choices=[('GirlGroup', 'GirlGroup'), ('BoyGroup', 'BoyGroup')], max_length=30, null=True)),
                ('idol_solo', models.CharField(blank=True, choices=[('GirlSolo', 'GirlSolo'), ('BoySolo', 'BoySolo')], max_length=30, null=True)),
                ('idol_name_kr', models.CharField(default='', max_length=7)),
                ('idol_name_en', models.CharField(default='', max_length=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('when', models.DateTimeField(default=datetime.datetime(2023, 3, 20, 9, 10, 27, 44705, tzinfo=datetime.timezone.utc))),
