    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ScheduleContent', models.CharField(max_length=150)),
                ('when', models.DateTimeField(default=datetime.datetime(2023, 3, 20, 5, 11, 28, 316578, tzinfo=datetime.timezone.utc))),
