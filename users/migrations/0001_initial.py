    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', error_messages={'unique': 'This name has already been registered.'}, max_length=100, validators=[django.core.validators.MinLengthValidator(2, '이름은 2자 이상이어야합니다.')])),
                ('nickname', models.CharField(default='', max_length=100, unique=True, validators=[django.core.validators.MinLengthValidator(3, '닉네임은 3자 이상이어야합니다.')])),
                ('email', models.EmailField(error_messages={'unique': '이미 사용중인 이메일입니다.'}, max_length=100, null=True, unique=True, verbose_name='Email-address')),
                ...
                ('pick', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='idols.idol')),
            ],
            options={
