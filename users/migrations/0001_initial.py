    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default=False, error_messages={'unique': 'This name has already been registered.'}, max_length=100, validators=[django.core.validators.MinLengthValidator(2, '이름은 2자 이상이어야합니다.')])),
                ...
                ('pick', models.ForeignKey(default='', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='idols.idol')),
            ],
            options={
